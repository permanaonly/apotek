		...
		<div class="main_container">
			...
			<footer>
				<div class="pull-right">
					<a href="https://http://rsh.fkh.ugm.ac.id/main/"> Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a> | Rumah Sakit Hewan Prof. Soeparwi</a> <?php echo $footer; ?>
				</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /Footer Content -->
